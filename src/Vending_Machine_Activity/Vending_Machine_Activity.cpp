...
#include "coupled_models/Vending_Machine_Activity/Vending_Machine_Activity.hpp"
...
int main() {
    ...
    std::string log_file = get_log_file_dir(cpp_file_path, "Vending_Machine_Activity");
        
   

    
    std::shared_ptr<Vending_Machine_Activity> model = std::make_shared<Vending_Machine_Activity>("0"
